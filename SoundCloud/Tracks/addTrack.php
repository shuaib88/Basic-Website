...
$usernameCheckQuery = "SELECT personName 
FROM person
...
if ($username = '$tuple[0]'){
	$query = "INSERT INTO track(numLikes, shares, trackName, trackPosterID) 
	...
	echo" <hr><b> back to tracks page: </b> <a href=https://mpcs53001.cs.uchicago.edu/~ahmed1/SoundCloud/Tracks/Tracks.html> Tracks Page </a>" ; 
}
